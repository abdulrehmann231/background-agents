...
import { Clock, Check, ChevronDown, GitPullRequest } from "lucide-react"
import { formatDistanceToNow } from "date-fns"
import { cn } from "@/lib/utils"
import { MessageBubble } from "@/components/MessageBubble"
import { type ScheduledJob, type ScheduledJobRun } from "@/lib/scheduled-jobs/types"
import type { Message } from "@/lib/types"
import { getRunStatusIcon, formatRunLabel, formatDuration } from "@/lib/scheduled-jobs/view-helpers"
...
/** Detail pane for a single job: header with run picker, plus the run's messages. */
export function JobRunDetail({ job, runs, selectedRun, messages, onSelectRun }: JobRunDetailProps) {
