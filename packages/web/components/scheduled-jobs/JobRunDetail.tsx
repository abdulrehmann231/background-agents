...
import type { ScheduledJob, ScheduledJobRun } from "@/lib/scheduled-jobs/types"
import type { Message } from "@/lib/types"
import { formatRunLabel, formatDuration } from "@/lib/scheduled-jobs/format"
import { getRunStatusIcon } from "./StatusIcons"
...
/**
 * Detail view for a single scheduled job: a run picker in the header and the
 * selected run's message transcript (plus completion / PR summaries).
 */
