...
// =============================================================================
// Presentational helpers shared by the scheduled-jobs list and detail views.
// =============================================================================
...
/** Status glyph for a job row, derived from enabled state + last run status. */
...
/** Status glyph for an individual run. */
