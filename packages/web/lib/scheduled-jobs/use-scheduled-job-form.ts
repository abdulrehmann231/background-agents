...
/**
 * Owns all state, side effects and server interactions for the Scheduled Job
 * form, so the component itself stays purely presentational. Covers create,
 * edit, draft "materialization" for the MCP picker, and incoming-webhook token
 * minting/rotation.
 */
